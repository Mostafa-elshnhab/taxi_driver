...
import 'package:taxi_drive/services/rider.dart';
import 'package:taxi_drive/services/user.dart';
...
class AppStateProvider with ChangeNotifier {
  ...
  Position? position;
  static LatLng _center= LatLng(35.68, 51.41);
...
//        if (doc.data()['id'] == id) {
//          requestModelFirebase = RequestModelFirebase.fromSnapshot(doc);
//          notifyListeners();
